...
" Spelling
autocmd BufRead,BufNewFile *.tex,*.md,*.gmi,*.html setlocal spell
autocmd BufRead,BufNewFile *.tex,*.md,*.gmi,*.html setlocal spelllang=en_gb,en_us,es_es,ca_ca
autocmd BufRead,BufNewFile *.tex,*.md,*.gmi,*.html inoremap <C-l> <c-g>u<Esc>[s1z=`]a<c-g>u

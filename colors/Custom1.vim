...
fun! s:register_default_theme()
  ...
  let s:themes['default'] = {
        ...
        \   'source' : 'http://github.com/NLKNguyen/papercolor-theme',
        \   'description' : 'The original Custom1 Theme, inspired by Google Material Design',
        \   'options' : {
        \       'allow_bold': 1
        \    }
        \ }
...
"
" Require Optionally:
"   {g:Custom1_Theme_[s:theme_name]}   <dictionary>  user custom theme palette
"   g:Custom1_Theme_Options            <dictionary>  user options
"
" Expose:
...
fun! s:acquire_theme_data()
  ...
  if exists("g:Custom1_Theme") " Users expressed theme preference
    let lowercase_theme_name = tolower(g:Custom1_Theme)

    if lowercase_theme_name !=? 'default'
      let theme_identifier = 'Custom1_' . lowercase_theme_name
  ...
  if exists("g:Custom1_Theme_Options")
    let s:options = g:Custom1_Theme_Options
  endif
  " }}}
...
"
" Require Optionally:
"   g:Custom1_Theme_Options  <dictionary>  user option config in .vimrc
"
" Expose:
"   s:langOpt_[LANGUAGE]__[OPTION]  <any>   variables for language options
"
" Example:
"     g:Custom1_Theme_Options has something like this:
"       'language': {
"       \   'python': {
"       \     'highlight_builtins': 1
"       \   }
...
" @brief command alias for g:Custom1()
command! -nargs=0 Custom1 :call g:Custom1()
" }}}
